...
import StoryImage1 from "../../../../../public/images/webp/story1.webp";
import StoryImage2 from "../../../../../public/images/webp/story2.webp";
import StoryImage3 from "../../../../../public/images/webp/story3.webp";
      ...
      <div className="container px-4 md:px-8 xl:px-4 mx-auto pt-20 md:pt-24 xl:pt-32 pb-40 lg:pb-52 relative">
        ...
        <div className="mt-16 lg:mt-20 xl:mt-24 w-full md:w-11/12 lg:w-10/12 xl:w-9/12 mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-3 md:gap-4 lg:gap-6">
            <Image src={StoryImage1} alt="Story 1" />
