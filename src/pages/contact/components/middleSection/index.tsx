...
const MiddleSection = () => {
  return (
    <section className="relative">
      <div className="container px-4 lg:px-8 xl:px-4 mx-auto pt-20 md:pt-24 lg:pt-28 pb-32 lg:pb-40 relative">
        <div className="flex flex-row flex-wrap">
          ...
          <div className="pt-6 flex-1 md:pl-6 lg:pl-8 xl:pl-12">
