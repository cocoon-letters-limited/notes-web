        ...
        <div className="w-full md:w-6/12 lg:w-5/12">
          <div className="md:pl-6 lg:pl-8">
            ...
            <div className="mt-6 flex">
              <Link
                className="bg-primary py-4 rounded-lg px-6 text-white font-semibold"
                to="/dev-centre/recorded?title=digital-marketing-class&id=1111&watch-video=true"
              >
                Start Course
              </Link>
            </div>
...
export default RecordedVideoDetails;
