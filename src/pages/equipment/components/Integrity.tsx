        ...
        <div>
            ...
            <div className='grid grid-cols-2'>
                <div className=''>
                    ...
                    <div className='flex  rounded-lg bg-blue-700 p-5 text-white'>
                        <p className='w-80'>PM Title</p>
                        <p className='w-64'>Pm Status </p>
                        <p className='w-64'>Due Data</p>
                        <Button
                        ...
                        >
                            <MenuItem onClick={handleClose}>
                                <div className="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                                    <input id="checkbox-item-4" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100
                    ...
                    <div className='flex justify-bet rounded-lg bg-white p-5  shadow my-3'>
                        <p className='w-40'>PM Title</p>
                        <div className='w-36'>
            ...
            <Modal
                ...
                <Box sx={style}>
                    ...
                    <div className='p-6'>
                        ...
                        <p className='my-4'>
                            Description: This machine has reached a potential failure and it’s likely to fail soon. Raise a maintainance work order to prevent this.
                        </p>
                        <span>Affected components:</span>
                        <span className="bg-blue-100 ml-5 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">Engine Casing</span>
                        ...
                        <label className="relative inline-flex items-center mb-4 cursor-pointer">
                            ...
                            <input type="checkbox" value="" className="sr-only peer" />
                                ...
                                <span className="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">No/Yes</span>
                        </label>
                        <br />
                        <li className="flex items-center">
                            <svg className="w-4 h-4 mr-1.5 text-blue-700 dark:text-green-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                            At least 10 characters
                        </li>

                        <div className='flex justify-between mt-14'>
                        <button className=' font-semibold e px-5 py-2  text-blue-700 rounded-lg '>
                            Create Note
                        </button>
