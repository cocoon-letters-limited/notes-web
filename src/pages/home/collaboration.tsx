      ...
      <div className="mt-48">
        <div className="md:flex ">
          <div className="md:w-1/1 md:pl-32 m-10 mb:p-0 md:container md:mx-auto">
            <p className="text-6xl text-blue-700  font-bold">
            ...
            <button className="bg-blue-700 hover:bg-blue-200 mr-3 text-white  font-bold py-3 pr-8 pl-8 px-4 rounded">
              {" "}
              Try for free
            </button>
            <div className="md:grid-cols-2 md:grid">
              ...
              <div className="mt-20 md:m-10">
                ...
                <p className="text-3xl mt-5 mb-5">Reduce downtime and costs</p>
                {/* <p className='text-2xl text-gray-400'>Odio euismod lacinia at quis. Amet purus gravida quis blandit turpis.</p> */}
              </div>
              <div className="mt-20 md:m-10">
                <button
