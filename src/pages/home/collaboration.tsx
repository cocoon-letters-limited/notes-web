    ...
    <div>
      <div className="p-10 md:p-0">
        <div className="md:flex ">
          <div className="md:w-1/1 md:pl-32 md:mr-32  mb:p-0 md:container md:mx-auto md:pr-20">
            <p className="text-4xl text-blue-700 mt-48  font-bold">
            ...
            <div className="md:grid-cols-2 md:grid ">
              <div className="mt-20 md:m-10">
                ...
                <p className="text-2xl mt-5 mb-5">
                  Standardize operational safety processes
                </p>
              ...
              <div className="mt-20 md:m-10">
                ...
                <p className="text-2xl mt-5 mb-5">
                  Extend asset productive lifespan
                </p>
                <p className=" text-gray-400">
                  Odio euismod lacinia at quis. Amet purus gravida quis blandit
                  turpis.
              ...
              <div className=" md:ml-10">
                <button
                  type="button"
                  className=" rounded-full p-4  flex text-blue-700 items-center justify-center"
                  style={{ background: " #EAEFF8" }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="text-2xl mt-5 mb-5">
                  Eliminate demand and supply tailback
                </p>
                <p className=" text-gray-400">
                  Odio euismod lacinia at quis. Amet purus gravida quis blandit
                  turpis.
              ...
              <div className=" md:ml-10">
                ...
                <p className="text-2xl mt-5 mb-5">Reduce downtime and costs</p>
                <p className=" text-gray-400">
                  Odio euismod lacinia at quis. Amet purus gravida quis blandit
                  turpis.
                </p>
          ...
          <img
            className=" md:w-1/2 object-none h-auto max-w-full   rounded"
            src={production2}
            alt="product"
            sizes=""
          />
