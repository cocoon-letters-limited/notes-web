...
const Home = () => {
  ...
  return <div>
   ...
   <img className="z-40 ml-4 mt-0 h-10 bg-yellow-400" src="./../../assets/images/Production 1.png" alt="product" sizes=""  />


  <div className='text-center'>
       <p className="text-4xl font-bold text-blue-600">Our Solution for your business</p>
       <p>We make it easy for users to use our platform, that's why we provide this benefit.</p>
  </div>
  </div>;
};
