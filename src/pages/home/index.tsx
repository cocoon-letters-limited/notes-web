...
const Home = () => {
  ...
  return <div className=''>
    <div className='' style={{ background: '#F1F5FF' }} >
      <div className=''>
          ...
          <div className='m-10 p-20'>
            ...
            <div className="md:grid md:grid-cols-2 gap-4 mt-10">
              <div>
                ...
                <p className='text-6xl  mt-3 mb-3 font-semibold w-10'>Seamless integration</p>
              ...
              <div className=''>
                <div className='flex'>
                  <button className=" rounded-full h-10 w-10 bg-white flex items-center justify-center">
                  ...
                  <p className='m-2 ml-5'>Secure and encrypted integration</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div>
        <div className="md:grid md:grid-cols-3  ">
          ...
          <div className='md:grid  '>
            <div className=" md:border-r-2  pb-5">
              <h5 className='text-6xl font-extrabold text-gray-200 '>01</h5>
              <p className='text-4xl pt-5 pb-5'>CMMS - Computerized Maintenance Management System </p>
        ...
        <div className='md:grid grid-cols-5'>
          <div className="max-w-sm text-center rounded overflow-hidden shadow-lg bg-orange-50" >
