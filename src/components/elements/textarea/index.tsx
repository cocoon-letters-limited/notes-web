...
const TextareaGroup = ({
  ...
  const defaultClassName = `mt-3 text-textColor block px-5 py-4 text-sm md:text-sm-15 lg:text-base w-full rounded-md bg-[#F8F8F8] placeholder-textColor focus:outline-none ${className}`;
